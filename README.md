...
- **TypeScript** throughout for catch-errors-before-they-happen development
...
Our mock API isn't just a placeholder—it's a **full simulation** of production behavior:
